...
```html
<!-- Background Glow -->
<div class="absolute inset-0 -inset-x-6 rounded-3xl bg-gradient-to-r from-emerald-300 via-blue-500 to-purple-700 opacity-10 blur-2xl"></div>

<!-- Glass Container -->
<div class="relative rounded-2xl bg-white/40 p-2.5 ring-1 ring-gray-200/50 backdrop-blur-sm dark:bg-gray-500/20 dark:ring-gray-700/60">
...
```html
<button
  [attr.aria-label]="'Navigate to ' + action.title"
  (click)="navigateToEntity(action.route)"
>
```
