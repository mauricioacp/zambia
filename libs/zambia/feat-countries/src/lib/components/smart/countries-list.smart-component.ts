        ...
        <div class="container mx-auto px-4 py-4 sm:px-6 sm:py-6">
          ...
          <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div class="flex flex-col items-center gap-4 text-center sm:flex-row sm:text-left">
              <div class="mx-auto rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 p-4 shadow-lg sm:mx-0">
              ...
              <div>
                ...
                <p class="text-sm text-gray-600 sm:text-base dark:text-slate-400">
                  {{ 'countries_description' | translate }}
                </p>
              </div>
            </div>
            <div class="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:items-center sm:gap-3">
              ...
              <button
                *zHasRole="allowedRolesForCountryCreation()"
                ...
                class="w-full bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 sm:w-auto"
              >
