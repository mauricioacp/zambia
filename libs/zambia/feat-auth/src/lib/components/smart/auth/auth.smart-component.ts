  ...
  template: `
    ...
    >
      ...
      <main id="page-content" class="flex max-w-full flex-auto flex-col">
        <div
          class="max-w-10xl relative mx-auto flex min-h-dvh w-full items-center justify-center overflow-hidden p-4 lg:p-8"
        >
          <!-- Log In Section -->
          <section class="w-full max-w-xl py-6">
            ...
            <header class="mb-10 text-center">
              <h1
                class="mb-2 inline-flex items-center gap-2 text-2xl font-bold"
              >
